...
and plotted separately in
[`evals/figures/generalization.png`](evals/figures/generalization.png) (not
overwritten by the full-dataset rerun above) so the comparison stays
reproducible:
