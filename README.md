...
![Generalization results across all four pipeline checkpoints, 30k-pair sycophancy-DPO subsample, train vs. test bias exploitation rate](evals/figures/generalization.png)

*The frozen 30k-subsample chart — compare against the full-dataset chart
above. Both are generated by the same `scripts/plot_results.py`; this one via
